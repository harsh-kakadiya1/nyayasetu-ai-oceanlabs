    ...
    <section className="mx-auto mb-14 max-w-6xl px-4 sm:px-6 lg:px-10">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        {stats.map(({ label, value, icon: Icon, suffix }) => (
          <article
            key={label}
            className="rounded-2xl border border-[#1f383c]/10 bg-white/80 p-5 shadow-[0_8px_18px_rgba(31,56,60,0.1)] transition-all duration-300 hover:shadow-[0_12px_28px_rgba(31,56,60,0.15)] hover:-translate-y-1"
          >
