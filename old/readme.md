...
- **Analysis History:** View and access all your previous document analyses.
- **Interactive Q&A:** Ask questions and get factual answers derived directly from document content using Groq AI.
...
- **AI Services**: Groq AI (compound/compound-mini models) for document analysis and Q&A
...
3. **Database Setup**
   ...
   # Get your database URL and add to .env
   ```
...
- **`server/services/`**: Groq AI integration and document parsing
